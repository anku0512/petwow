...
class DogBreedListWidget extends StatefulWidget {
  const DogBreedListWidget({Key key}) : super(key: key);

  @override
  _DogBreedListWidgetState createState() => _DogBreedListWidgetState();
}

class _DogBreedListWidgetState extends State<DogBreedListWidget> {
