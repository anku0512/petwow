                      ...
                      Expanded(
                        child: TabBarView(
                          children: [
                            Container(
                              ...
                              child: StreamBuilder<List<ChallengeRecord>>(
                                stream: queryChallengeRecord(
                                  queryBuilder: (query) =>
                                      // adding a query here to filter out the unwanted records
                                      query.where('duration', isGreaterThanOrEqualTo: getCurrentTimestamp),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                  ...
                                  List<ChallengeRecord> pageViewChallengeRecordList = snapshot.data;
                                  return Container(
                                    width: double.infinity,
                                    height: 500,
                                    child: Stack(
                                        ...
                                        Padding(
                                          ...
                                          child: PageView.builder(
                                            controller: pageViewController ??= PageController(
                                                initialPage: min(0, pageViewChallengeRecordList.length - 1)),
                                            scrollDirection: Axis.horizontal,
                                            itemCount: pageViewChallengeRecordList.length,
                                            itemBuilder: (context, pageViewIndex) {
                                              final pageViewChallengeRecord =
                                                  pageViewChallengeRecordList[pageViewIndex];
                                              return Container(
                                                width: 375,
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  pageViewChallengeRecord.statement,
                                                                ...
                                                                Align(
                                                                  ...
                                                                  child: FFButtonWidget(
                                                                    onPressed: () async {
                                                                      ...
                                                                      setState(() =>
                                                                          FFAppState().imagepost = uploadedFileUrl);
                                                                      setState(() => FFAppState().challengeEntry =
                                                                          pageViewChallengeRecord.reference);
                                                                      if (uploadedFileUrl != null &&
                                                                          uploadedFileUrl != '') {
                                                                        await Navigator.push(
                                                                          context,
                                                                          MaterialPageRoute(
                                                                            builder: (context) => ChallengePostWidget(),
                                                                          ),
                                                                        );
                                                                      } else {
                                                                        return;
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: StreamBuilder<List<PostsRecord>>(
                                                            ...
                                                            builder: (context, snapshot) {
                                                              ...
                                                              List<PostsRecord> latestFeedPostsRecordList =
                                                                  snapshot.data;
                                                              return Column(
                                                                mainAxisSize: MainAxisSize.max,
                                                                children:
                                                                    List.generate(latestFeedPostsRecordList.length,
                                                                        (latestFeedIndex) {
                                                          ...
                                                          child: StreamBuilder<List<PostsRecord>>(
                                                            ...
                                                            builder: (context, snapshot) {
                                                              ...
                                                              return Column(
                                                                mainAxisSize: MainAxisSize.max,
                                                                children:
                                                                    List.generate(popularFeedPostsRecordList.length,
                                                                        (popularFeedIndex) {
                                                                  final popularFeedPostsRecord =
                                                                      popularFeedPostsRecordList[popularFeedIndex];
                                                                  return Padding(
                                                                    padding:
                                                                        EdgeInsetsDirectional.fromSTEB(0, 8, 0, 12),
                                                                    child: StreamBuilder<UsersRecord>(
                                                                      stream: UsersRecord.getDocument(
                                                                          popularFeedPostsRecord.user),
                                                                      builder: (context, snapshot) {
                                                                        // Customize what your widget looks like when it's loading.
                                                                        if (!snapshot.hasData) {
                                                                          return Center(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: StreamBuilder<List<PostsRecord>>(
                                                            ...
                                                            builder: (context, snapshot) {
                                                              ...
                                                              List<PostsRecord> myEntryFeedPostsRecordList =
                                                                  snapshot.data;
                                                              return Column(
                                                                mainAxisSize: MainAxisSize.max,
                                                                children:
                                                                    List.generate(myEntryFeedPostsRecordList.length,
                                                                        (myEntryFeedIndex) {
                                                                  final myEntryFeedPostsRecord =
                                                                      myEntryFeedPostsRecordList[myEntryFeedIndex];
                                                                  return Padding(
                                                                    padding:
                                                                        EdgeInsetsDirectional.fromSTEB(0, 8, 0, 12),
                                                                    child: StreamBuilder<UsersRecord>(
                                                                      stream: UsersRecord.getDocument(
                                                                          myEntryFeedPostsRecord.user),
                                                                      builder: (context, snapshot) {
                                                                        // Customize what your widget looks like when it's loading.
                                                                        if (!snapshot.hasData) {
                                                                          return Center(
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: SmoothPageIndicator(
                                              controller: pageViewController ??= PageController(
                                                  initialPage: min(0, pageViewChallengeRecordList.length - 1)),
                                              count: pageViewChallengeRecordList.length,
                            ...
                            PagedListView<DocumentSnapshot<Object>, ChallengeRecord>(
                              pagingController: () {
                                final Query<Object> Function(Query<Object>) queryBuilder =
                                    (challengeRecord) => challengeRecord.orderBy('created_at');
                                if (_pagingController != null) {
                                  final query = queryBuilder(ChallengeRecord.collection);
                                ...
                                _pagingQuery = queryBuilder(ChallengeRecord.collection);
                                _pagingController.addPageRequestListener((nextPageMarker) {
                                  queryChallengeRecordPage(
                                    queryBuilder: (challengeRecord) => challengeRecord.orderBy('created_at'),
                              ...
                              padding: EdgeInsets.zero,
                              scrollDirection: Axis.vertical,
                              builderDelegate: PagedChildBuilderDelegate<ChallengeRecord>(
                                ...
                                itemBuilder: (context, _, listViewIndex) {
                                  final listViewChallengeRecord = _pagingController.itemList[listViewIndex];
                                  return Visibility(
                                    visible: listViewChallengeRecord.duration <= getCurrentTimestamp,
                                    child: InkWell(
                                      onTap: () async {
                                        setState(() => FFAppState().challengeEntry = listViewChallengeRecord.reference);
                                        await Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => PastChallengeWidget(),
                                          ),
                                        );
                                      },
                                      child: Card(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        dateTimeFormat('relative', listViewChallengeRecord.duration),
                                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                                              fontFamily: 'Poppins',
                                                              color: Colors.black,
                                                            ),
