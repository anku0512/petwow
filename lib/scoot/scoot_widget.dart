...
import '../post_page_scoot/post_page_scoot_widget.dart';
...
class ScootWidget extends StatefulWidget {
  ...
  @override
  _ScootWidgetState createState() => _ScootWidgetState();
}
            ...
            children: [
              Stack(
                children: [
                  Stack(
                    children: [
                      Image.network(
                        'https://images.unsplash.com/photo-1622477011079-e1dabfe63cdd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80',
                        width: MediaQuery.of(context).size.width,
                        height: 200,
                        fit: BoxFit.cover,
                      ),
                      if ((currentUserDocument?.taskScoot) == 'Mastered')
                        Align(
              ...
              Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            "Place a treat at his chest and gently and slowly move it in towards " +
                                _herHim +
                                ". This should cause " +
                                _herHim +
                  ...
                  Image.network(
                    'https://media.giphy.com/media/fX8oIMwSyX0zJbGoEy/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
                ...
                children: [
                  Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                "Once " +
                                    _currentUserDisplayName +
                                    " is comfortable with scooting backwards with a lure, move on to leaning towards " +
                                    _herHim +
                                    " in order to have " +
                                    _herHim +
                      ...
                      Image.network(
                        'https://media.giphy.com/media/cPUJs8uejJ4efDUDEr/giphy.gif',
                        width: MediaQuery.of(context).size.width,
                        height: 300,
                        fit: BoxFit.cover,
                      ),
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            "Once " +
                                _currentUserDisplayName +
                                " is successfully scooting backwards 9 out of 10 times with a lure, begin giving a verbal cue such as \"Scoot\" just before " +
                                _sheHe +
