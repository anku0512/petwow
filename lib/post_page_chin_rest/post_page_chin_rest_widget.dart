...
class PostPageChinRestWidget extends StatefulWidget {
  const PostPageChinRestWidget({Key key}) : super(key: key);

  @override
  _PostPageChinRestWidgetState createState() => _PostPageChinRestWidgetState();
}

class _PostPageChinRestWidgetState extends State<PostPageChinRestWidget> {
  ...
  void initState() {
    ...
    textController = TextEditingController(
        text: 'Hey! look I just trained my dog with this adorable trick.');
  }
