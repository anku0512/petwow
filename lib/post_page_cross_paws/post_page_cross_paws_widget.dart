...
class PostPageCrossPawsWidget extends StatefulWidget {
  const PostPageCrossPawsWidget({Key key}) : super(key: key);

  @override
  _PostPageCrossPawsWidgetState createState() =>
      _PostPageCrossPawsWidgetState();
}

class _PostPageCrossPawsWidgetState extends State<PostPageCrossPawsWidget> {
  ...
  void initState() {
    ...
    textController = TextEditingController(
        text: 'Hey! look my dog just learned this awesome new trick.');
  }
