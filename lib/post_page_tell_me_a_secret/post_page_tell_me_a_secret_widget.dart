...
class PostPageTellMeASecretWidget extends StatefulWidget {
  const PostPageTellMeASecretWidget({Key key}) : super(key: key);

  @override
  _PostPageTellMeASecretWidgetState createState() =>
      _PostPageTellMeASecretWidgetState();
}

class _PostPageTellMeASecretWidgetState
    extends State<PostPageTellMeASecretWidget> {
  ...
  void initState() {
    super.initState();
    textController =
        TextEditingController(text: 'Hey! look my dog talks to me ');
  }
