...
class PostPageSpinWidget extends StatefulWidget {
  const PostPageSpinWidget({Key key}) : super(key: key);

  @override
  _PostPageSpinWidgetState createState() => _PostPageSpinWidgetState();
}

class _PostPageSpinWidgetState extends State<PostPageSpinWidget> {
  ...
  void initState() {
    ...
    textController = TextEditingController(
        text: 'Hey! look my dog just learned a new trick of spinning');
  }
