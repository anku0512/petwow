                ...
                children: [
                  Stack(
                    children: [
                      ...
                      if ((currentUserDocument?.placeworkIntro) == 'Mastered')
                        Align(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'one paw at a time and slowly build up',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Color(0xFF050505),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'get all four paws onto the cot)',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Color(0xFF050505),
                  ...
                  Image.network(
                    'https://media.giphy.com/media/qVQZIHX6GFRy49ViGr/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(42, 0, 10, 0),
                        child: Text(
                          'has all four paws on the cot. Reward with each success.',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Colors.black,
                      ...
                      Image.network(
                        'https://media.giphy.com/media/JPMXPNhZElQx4N6AeM/giphy.gif',
                        width: MediaQuery.of(context).size.width,
                        height: 300,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(42, 0, 10, 0),
                        child: Text(
                          'starts to lie down without asking. Reward with each success.',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Colors.black,
                      ...
                      Image.network(
                        'https://media.giphy.com/media/QEg1nf9utiRsC7Wt34/giphy.gif',
                        width: MediaQuery.of(context).size.width,
                        height: 300,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(42, 0, 10, 0),
                        child: Text(
                          'going onto the cot and lying down 9 out of 10 times with a lure, begin giving a verbal cue such as \"Place\" just before',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Colors.black,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'In the beginning, placework may be ',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'scared of the new \"place\" object, make',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
