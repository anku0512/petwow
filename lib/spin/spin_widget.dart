...
import '../post_page_spin/post_page_spin_widget.dart';
            ...
            children: [
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      if ((currentUserDocument?.taskSpin) == 'Mastered')
                        Align(
                        ...
                        children: [
                          AuthUserStreamWidget(
                            child: FlutterFlowDropDown(
                              initialOption: dropDownValue ??= valueOrDefault(currentUserDocument?.taskSpin, 'Not in progress'),
              ...
              Column(
                ...
                children: [
                  ...
                  Image.network(
                    'https://media.giphy.com/media/9Vom5nJza84DypuHs1/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
              ...
              Column(
                ...
                children: [
                  ...
                  Image.network(
                    'https://media.giphy.com/media/0IXn4it8E446Q4X7re/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
