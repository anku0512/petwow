                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'by your side and play a doorbell sound.',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'cue the place command. Feel free to',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Color(0xFF050505),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'needs to complete the behaviour successfully. Reward for every successfull behaviour.',
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Once the above steps are mastered, ',
                              style: FlutterFlowTheme.of(context)
                                  .bodyText1
                                  .override(
                                    fontFamily: 'Poppins',
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'ring the doorbell and wait until ',
                              style: FlutterFlowTheme.of(context)
                                  .bodyText1
                                  .override(
                                    fontFamily: 'Poppins',
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(42, 0, 10, 0),
                        child: Text(
                          'the place behavior without a cue. Reward for each success.',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Colors.black,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(42, 0, 10, 0),
                        child: Text(
                          'slowly increase distance and eventually ',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: Colors.black,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'You can also use the steps above for ',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'knocking or any similar trigger.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'If it\'s more convenient, you can also use',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                            ...
                            Padding(
                              ...
                              child: Text(
                                'a bluetooth speaker and a recorded doorbell sound for training!',
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                                      fontFamily: 'Poppins',
