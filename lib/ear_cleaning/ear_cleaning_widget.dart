...
class EarCleaningWidget extends StatefulWidget {
  const EarCleaningWidget({Key key}) : super(key: key);

  @override
  _EarCleaningWidgetState createState() => _EarCleaningWidgetState();
}

class _EarCleaningWidgetState extends State<EarCleaningWidget> {
              ...
              Stack(
                children: [
                  Stack(
                    children: [
                      Image.network(
                        'https://media.giphy.com/media/o99OZNZXwBUcjTCmQh/giphy-downsized-large.gif',
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Clean your dog\'s ears every few weeks to get rid of excess ear wax and prevent infections.',
                        ...
                        Flexible(
                          child: Text(
                            "Introduce " +
                                ...
                                " to the cleaner bottle by having " +
                                _herHim +
                ...
                children: [
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                "Once " +
                                    _currentUserDisplayName +
                                    " is comfortable with step 2, move on to cleaning " +
                                    _herHis +
                                    " ear. Without putting the tip of the bottle too deep inside " +
                                    _herHis +
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Image.network(
                        'https://media.giphy.com/media/UgnngKrfFihX6QMplC/giphy.gif',
                        width: MediaQuery.of(context).size.width,
                        height: 300,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Image.network(
                        'https://media.giphy.com/media/UQ41H2t54xpwrpBRx9/giphy.gif',
                        width: MediaQuery.of(context).size.width,
                        height: 300,
                        fit: BoxFit.cover,
                      ),
