...
import '../post_page_tell_me_a_secret/post_page_tell_me_a_secret_widget.dart';
...
class TellMeASecretWidget extends StatefulWidget {
  const TellMeASecretWidget({Key key}) : super(key: key);

  @override
  _TellMeASecretWidgetState createState() => _TellMeASecretWidgetState();
}

class _TellMeASecretWidgetState extends State<TellMeASecretWidget> {
            ...
            children: [
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      if ((currentUserDocument?.taskTellMeASecret) ==
                          'Mastered')
                        Align(
                        ...
                        children: [
                          AuthUserStreamWidget(
                            child: FlutterFlowDropDown(
                              initialOption: dropDownValue ??= valueOrDefault(currentUserDocument?.taskTellMeASecret, 'Not in progress'),
                              options: ['Not in progress', 'In Progress', 'Mastered'],
                              onChanged: (val) async {
                                final usersUpdateData = createUsersRecordData(
                                  taskTellMeASecret: val,
                                );
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(
                              child: Text(
                                "Everybody will be wondering what " +
              ...
              Column(
                ...
                children: [
                  ...
                  Image.network(
                    'https://media.giphy.com/media/s2IW01oBKbXBM4GhbP/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
              ...
              Column(
                ...
                children: [
                  ...
                  Image.network(
                    'https://media.giphy.com/media/FwwUEQIQL4hiflsHzB/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            "Once " +
                                _currentUserDisplayName +
                                " is successfully holding " +
                                _herHis +
                                " nose to your hand 9 out of 10 times with a verbal cue, begin giving a verbal cue such as \"Secret\" just before " +
                                _sheHe +
              ...
              Column(
                ...
                children: [
                  ...
                  Image.network(
                    'https://media.giphy.com/media/TwNguXeNampKSRuYXO/giphy-downsized-large.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
              ...
              Column(
                ...
                children: [
                  ...
                  Image.network(
                    'https://media.giphy.com/media/rhVtwpy5lXrSi7P9O3/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
              ...
              Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            "Repeat step 6 several times until " +
                                _currentUserDisplayName +
                                " is able to keep " +
                                _herHis +
                  ...
                  Image.network(
                    'https://media.giphy.com/media/iQ0XKb7Di9a6DdEvmQ/giphy.gif',
                    width: MediaQuery.of(context).size.width,
                    height: 300,
                    fit: BoxFit.cover,
                  ),
